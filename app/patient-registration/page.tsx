      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[92vh] flex flex-col">
        ...
        <div className="overflow-y-auto flex-1 p-6">
          <div ref={ref}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '3px solid #0f172a', paddingBottom: '12px', marginBottom: '14px' }}>
              <div>
                <div style={{ fontSize: '28px', fontWeight: '900', color: '#0f172a', letterSpacing: '-0.5px' }}>
                  Nitsat <span style={{ color: '#2563eb' }}>Hospital Software</span>
                </div>
                <div style={{ fontSize: '11px', fontWeight: '700', color: '#334155', marginTop: '2px' }}>
                  Multispeciality Hospital Management System
                </div>
                <div style={{ fontSize: '10px', color: '#475569', marginTop: '2px' }}>
                  📍 48 Rajpura, Bhadohi, Uttar Pradesh – India
                </div>
                <div style={{ fontSize: '10px', color: '#475569' }}>
                  ☎ +91-XXXXXXXXXX | ✉ nitsathospital@gmail.com
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
                ...
                <span style={{
                  display: 'inline-block', padding: '3px 14px', borderRadius: '20px', fontSize: '11px', fontWeight: '800', marginTop: '5px',
            ...
            {/* Consent */}
            {/* Consent / Undertaking Form */}
<div style={{border:'1px solid #0f172a',borderRadius:'6px',padding:'12px',marginTop:'10px'}}>
  ...
  <div style={{
    ...
    INFORMED CONSENT FOR {registration.registration_type === 'IPD' ? 'INDOOR TREATMENT' : 'OUTPATIENT TREATMENT'} 
    / आंतरिक उपचार हेतु सूचित सहमति पत्र
  </div>

  <p style={{fontSize:'10px',lineHeight:'1.7',color:'#1e293b',textAlign:'justify'}}>
    मैं/हम <b>{patient.first_name} {patient.last_name || ''}</b> (UHID: {patient.uhid}),
    निवासी {patient.address || patient.city || '____________'} यह घोषित करते हैं कि मैं अपने मरीज को 
    Nitsat Hospital Software, 48 Rajpura, Bhadohi में भर्ती/उपचार हेतु स्वेच्छा से लेकर आया/लाई हूँ।
    मरीज का उपचार Dr. <b>{registration.doctor_name || registration.consultant_name || '____________'}</b> 
    के अधीन किया जाएगा।
  </p>

  <p style={{fontSize:'10px',lineHeight:'1.7',color:'#1e293b',textAlign:'justify',marginTop:'6px'}}>
    मुझे चिकित्सा विज्ञान की अनिश्चितता के बारे में पूर्ण जानकारी दी गई है तथा यह समझाया गया है कि 
    किसी भी उपचार या प्रक्रिया के परिणाम की पूर्ण गारंटी नहीं दी जा सकती। 
    मैं अस्पताल के नियमों एवं निर्देशों का पालन करूंगा/करूंगी।
  </p>

  <p style={{fontSize:'10px',lineHeight:'1.7',color:'#1e293b',textAlign:'justify',marginTop:'6px'}}>
    I hereby give my full consent for medical examination, investigation and treatment of the patient 
    under the supervision of Dr. {registration.doctor_name || registration.consultant_name || '________'} 
    at Nitsat Hospital Software. I understand that hospital shall not be responsible for any loss of 
    valuables during hospitalization and I agree to clear all hospital dues.
  </p>

  <p style={{fontSize:'10px',lineHeight:'1.7',color:'#1e293b',textAlign:'justify',marginTop:'6px'}}>
    बीमा / TPA / पैनल द्वारा दावा अस्वीकृत होने की स्थिति में समस्त बिल का भुगतान करना मेरी जिम्मेदारी होगी।
    मैं प्रमाणित करता/करती हूँ कि इस सहमति पत्र में दी गई सभी जानकारी मेरे द्वारा सही एवं स्वेच्छा से दी गई है।
  </p>
  ...
  <div style={{textAlign:'center'}}>
    <div style={{borderTop:'1px solid #000',marginTop:'40px'}}></div>
    <div style={{fontSize:'10px',fontWeight:'700'}}>Patient / Guardian Signature</div>
    <div style={{fontSize:'9px',color:'#64748b'}}>
      Name: {registration.guardian_name || patient.first_name}
    </div>
  </div>

  <div style={{textAlign:'center'}}>
    <div style={{borderTop:'1px solid #000',marginTop:'40px'}}></div>
    <div style={{fontSize:'10px',fontWeight:'700'}}>Consultant Doctor</div>
    <div style={{fontSize:'9px',color:'#64748b'}}>
      Dr. {registration.doctor_name || registration.consultant_name || '________'}
    </div>
  </div>
...
Printed: {now.toLocaleString()} · Nitsat Hospital Software · 48 Rajpura, Bhadohi · All Rights Reserved            </div>
          </div>
        </div>
      </div>
    </div>
